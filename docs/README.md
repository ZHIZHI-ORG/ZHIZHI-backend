...
| [docs/designs/zhizhi-ai-personalization-question-planning-architecture.md](designs/zhizhi-ai-personalization-question-planning-architecture.md) | CURRENT | EXPERIMENTAL | WORKTREE | 2026-08-05 | Recommendation V1 的有界时间检索、30 张候选池、三批 10 张大卡编排、内容/时间记忆与验收合同 | Critical | Recommendation model/AI/service/migrations 013-015/routes/eval + iOS；线上未验证 |
